...
class Puzzle{
 ...
 public:
    ...
    // puzzle map
    // each map value contains current position state (order: left right top bottom)
...
// ------------------------------------ puzzle 2 --------------------------------------
  ...
  printf("Puzzle2\n");
  // print solution of puzzle2
  minotaurPuzzle2.solvePuzzle();
...
// ------------------------------------ puzzle 3 --------------------------------------
  ...
  printf("Puzzle3\n");
  // print solution of puzzle3
  minotaurPuzzle3.solvePuzzle();
...
// ------------------------------------ puzzle 4 --------------------------------------
  ...
  printf("Puzzle4\n");
  // print solution of puzzle4
  minotaurPuzzle4.solvePuzzle();
...
// ------------------------------------ puzzle 5 --------------------------------------
  ...
  printf("Puzzle5\n");
  // print solution of puzzle5
  minotaurPuzzle5.solvePuzzle();
